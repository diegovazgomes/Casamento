...
[x] - Adicionar botão para criar conta na tela de login
[x] - Exibir mensagem clara quando o email já estiver cadastrado ao criar conta

### Wizard de criação

[x] - Corrigir o wizard para exibir apenas um tema fixo no plano free, com seleção travada em classic-gold
[x] - Remover a lista de 4 temas do plano free na etapa de temas quando a conta estiver no plano free (colocar informação de que mais planos estão disponiveis na versão premium)
[x] - Ajustar a caixa de mensagem de música indisponível no plano free para aparecer no lugar correto e com o texto correto

### Mapa e presentes

[x] - Corrigir o mapa que está bugado na experiência do convite
[x] - Garantir que a lista de presentes receba atualização de nome e preço dos itens
[x] - Remover o texto descritivo não editável da lista de presentes para evitar confusão ao trocar os itens

### Upload e mídia

[x] - Tratar o erro visível quando o envio de imagem para a galeria falhar por excesso de payload

### Próximas melhorias por área
